...
function orderdeal(id,status){
		layer.confirm('确定修改订单状态吗？',function(index){		
		     $.ajax({
            type: "POST",
            url: "/waimai/index.php/Admin/Shop/orderStatusUpdate",
...
function logout(obj,id){
	layer.confirm('确定要退出吗？',function(index){		
		     $.ajax({
            type: "POST",
            url: "/waimai/index.php/Admin/Public/logout",
            data: {},
            success: function(msg){
            	if(msg){
...
/*管理员-权限-删除*/
function admin_permission_del(obj,id,url){
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
